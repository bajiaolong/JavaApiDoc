                    ...
                    <div class="action-list">
                        <#list controller.requestNodes as reqNode>
                            <div class="action-item">
                                ...
                                <#assign autoId = reqNode_index+1/>
                                <#if reqNode.lastRequestNode?? && reqNode.changeFlag == 2>
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#current"
                                                                                  aria-controls="current" role="tab"
                                                                                  data-toggle="tab">${i18n.getMessage('currentVersion')}</a>
                                        </li>
                                        <li role="presentation"><a href="#last" aria-controls="last" role="tab"
                                                                   data-toggle="tab">${i18n.getMessage('lastVersion')}</a>
                                        </li>
                                    </ul>
