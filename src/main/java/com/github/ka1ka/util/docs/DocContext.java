...
import com.github.ka1ka.util.docs.exception.ConfigException;
...
public class DocContext {
    ...
    /**
     * 获取输出响应信息
     * @param projectType 项目类型  pom文件为spring
     * @return void
     **/
        ...
        for (String javaSrcPath : getJavaSrcPaths()) {
            ...
            switch (projectType) {
                ...
                case SPRING:
                    ...
                    //过滤出所有的controller类 并且没有带上ignore注解的
    ...
    private static void setDocPath(DocsConfig config) {
        if (config.docsPath == null || config.docsPath.isEmpty()) {
            config.docsPath = projectPath+ "//src//main//resources//static//docs";
        }
